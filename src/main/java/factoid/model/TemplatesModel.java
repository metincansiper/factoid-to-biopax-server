...
public class TemplatesModel {
  ...
  public void addProteinModification(EntityModel targetProteinModel, EntityModel controllerProteinModel,
                                     String modificationType, ControlType controlType) {
    ...
    Protein left = model.getOrCreatePhysicalEntity(Protein.class, targetProteinName, null,
      protRef, leftModificationTypes);
    Protein right = model.getOrCreatePhysicalEntity(Protein.class, targetProteinName, null,
      protRef, rightModificationTypes);

    ProteinReference controllerRef = model.getOrCreateEntityReference(ProteinReference.class,
      controllerProteinName, controllerProteinXref);
  ...
  public void addRegulationOfExpression(EntityModel transcriptionFactorModel, EntityModel targetProtModel,
  ...
  private void addProteinControlsConsumptionOrProduction(EntityModel controllerProteinModel,
                                                         EntityModel chemicalModel, SideType chemicalSide) {
    String controllerProteinName = controllerProteinModel.getName();
    XrefModel controllerProteinXref = controllerProteinModel.getXref();
...
//		addNewSmallMoleculeToConversion(reaction, otherChemName, otherSide);
    ...
    ProteinReference catalyzerRef = model.getOrCreateEntityReference(ProteinReference.class,
      controllerProteinName, controllerProteinXref);
  ...
  private <T1 extends PhysicalEntity, T2 extends EntityReference> void addStateChange(
    EntityModel controllerModel, EntityModel targetProteinModel, ControlType controlType,
    Class<T1> controllerClass, Class<T2> controllerRefClass) {
    ...
    ProteinReference targetProtRef = model.getOrCreateEntityReference(ProteinReference.class,
      targetProteinName, targetProteinXref);
    ...
    Protein leftProtein = model.getOrCreatePhysicalEntity(Protein.class, targetProteinName, null,
      targetProtRef, leftModificationTypes);
    Protein rightProtein = model.getOrCreatePhysicalEntity(Protein.class, targetProteinName, null,
      targetProtRef, rightModificationTypes);
  ...
  private void addNewSmallMoleculeToConversion(Conversion conversion, EntityModel moleculeModel, SideType sideType) {
    ...
    SmallMoleculeReference moleculeRef = model.getOrCreateEntityReference(SmallMoleculeReference.class,
      moleculeName, moleculeXref);
...
//	}
  ...
  private static void addActiveInactiveModifications(ControlType controlType, Set<String> leftModificationTypes,
                                                     Set<String> rightModificationTypes) {
